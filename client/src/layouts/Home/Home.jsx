...
export const Home = ({ joinExistingGame, startNewGame }) => {
    ...
    return (
        <div className="home-wrapper">
            <h1 className="welcome-text">{translateCommon('welcomeToPlayCardsAgainstHumankind', t)}!</h1>

            <div className="create-or-join-game-buttons">
                <div className="container">
                    <div className="text">{translateCommon('createNewGame', t)}</div>
                ...
                <div className="container border">
                    <div className="text">{translateCommon('joinExistingGame', t)}</div>
                    <div className="input-and-button-container">
                        <TextControl
                            className="input"
