...
export const Button = React.forwardRef((props, ref) => {
    const { additionalClassname, callback, callbackParams, disabled, fill, icon, iconPosition, text, type } = props;
    ...
    return (
        ...
        >
            ...
            {text}
            {icon && iconPosition === 'after' && <Icon name={icon} className={classNames('button-icon', 'after-text')} />}
        </button>
    );
});
